...
export const metadata: Metadata = {
  ...
  description:
    'Learn about our return and refund policy for books and honey products on M4KTABA.',
};
              ...
              <Card>
                ...
                <CardContent>
                  <ul className='space-y-2 text-sm'>
                    <li>
                      • Books in any condition (including with
            ...
            <div className='space-y-4'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    If your item arrives damaged, please contact us immediately
                    with photos.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <p className='text-sm text-muted-foreground'>
                    Please contact us within 48 hours of delivery to report
                    wrong items.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className='text-sm text-muted-foreground'>
                    Honey products must be unopened and in original packaging.
                    Opened honey products cannot be returned for hygiene
                    reasons.
                  </p>
                </CardContent>
              </Card>
