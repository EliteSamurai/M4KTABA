...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Learn about how M4KTABA uses cookies and similar technologies to enhance your browsing experience.",
};
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            This page explains how M4KTABA uses cookies and similar technologies when you visit our website.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Used for advertising and marketing</CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Website analytics and performance tracking</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Payment processing and security</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Stripe uses cookies to process payments securely and prevent fraud. These are essential for our payment functionality.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Social sharing and integration</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Control cookies through your web browser</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your preferences on our website</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
