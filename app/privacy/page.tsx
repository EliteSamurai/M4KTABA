...
export const metadata: Metadata = {
  ...
  description:
    'Learn how M4KTABA protects your privacy and handles your personal information.',
};
        ...
        <div className='space-y-8'>
            ...
            <div className='space-y-4'>
                ...
                <CardContent>
                  <ul className='space-y-2 text-sm'>
                    ...
                    <li>
                      ...
                      payment method (processed securely by Stripe)
                    </li>
                    <li>
                      • <strong>Communication:</strong> Messages, reviews, and
                      feedback you send us
                    </li>
                    <li>
                      • <strong>Seller Information:</strong> Business details,
              ...
              <Card>
                ...
                <CardContent>
                  <ul className='space-y-2 text-sm'>
                    <li>
                      • <strong>Activity Data:</strong> Pages visited, searches,
                      purchases, listings created
                    </li>
                    <li>
                    ...
                    <li>
                      • <strong>Location Data:</strong> General location based
                      on IP address
                    </li>
                    <li>
          ...
          <section>
            ...
            <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-6'>
              ...
              <div className='space-y-2 text-sm text-yellow-800'>
                <p>
                  <strong>
                    We may share information only in these limited
                    circumstances:
                  </strong>
                </p>
              ...
              <Card>
                ...
                <CardContent>
                  <ul className='space-y-2 text-sm'>
                    ...
                    <li>
                      • <strong>Secure Servers:</strong> We use industry-leading
                    ...
                    <li>
                      • <strong>Payment Security:</strong> Payment processing
                      handled by PCI-compliant Stripe
                    </li>
                  </ul>
                </CardContent>
              </Card>
                ...
                <div className='space-y-4'>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Handles all payment processing. Your payment information
                  ...
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Helps us understand website usage with anonymized data.
                      You can opt out.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className='text-sm text-muted-foreground'>
                      Stores product information and blog content. No personal
                      data is stored here.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              <CardContent className='pt-6'>
                <p className='text-sm text-muted-foreground'>
                  ...
                  platform. Your continued use of our services after changes are
          ...
          <section className='bg-slate-50 rounded-lg p-6'>
            ...
            <div className='space-y-2 text-sm'>
              <p>
                <strong>Email:</strong> contact@m4ktaba.com
              </p>
              <p>
