...
const steps = [
  { id: 1, title: "Book Details", icon: BookOpen, description: "Basic information about your book" },
  { id: 2, title: "Condition & Price", icon: DollarSign, description: "Set the condition and pricing" },
  { id: 3, title: "Photos", icon: Camera, description: "Add photos of your book" },
  { id: 4, title: "Review & Submit", icon: CheckCircle, description: "Review your listing" },
];
    ...
    switch (currentStep) {
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter the full title" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    A good description helps buyers understand what they're getting
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Tasawwuf">Tasawwuf & Spirituality</SelectItem>
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-2">Condition & Pricing</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>No platform fees!</strong> You keep 100% of your sale price. 
                We only charge for payment processing (Stripe fees apply).
              </AlertDescription>
            </Alert>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <p><strong>Language:</strong> {form.watch("language")}</p>
                      <p><strong>Category:</strong> {form.watch("category")}</p>
                      <p><strong>Condition:</strong> {conditions.find(c => c.value === form.watch("condition"))?.label}</p>
                      <p><strong>Quantity:</strong> {form.watch("quantity")}</p>
                      {form.watch("isbn") && <p><strong>ISBN:</strong> {form.watch("isbn")}</p>}
                    </div>
                  </div>
                  <div>
                ...
                {uploadedImages.length > 0 && (
                  <div>
                    <h4 className="font-medium mb-2">Photos ({uploadedImages.length})</h4>
