import { checkoutReducer, initialCheckoutState, isBusy, canSubmit } from "@/app/checkout/checkout.machine";
...
describe("checkout.machine", () => {
  ...
  test("guards: cannot submit while busy", () => {
    const validating = checkoutReducer(initialCheckoutState, { type: "SUBMIT" });
